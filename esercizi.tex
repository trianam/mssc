...
transizioni, alternativamente che $\forall\mu\in\mathcal{A}_{CCS}:\ t_1\xrightarrow{\mu}t\iff t_2\xrightarrow{\mu}t$. 
\begin{enumerate}
\item Se $p|q\xrightarrow{\mu}t$ significa che è stata usata una tra
